...
huggingface-cli download zhihan1996/DNABERT-2-117M --local-dir inference/DNABERT2/model
```

После этого в `inference/DNABERT2/model` появятся `config.json`, файлы токенизатора, веса и т.д.
