...
Токенизатор по умолчанию: inference/DNABERT2/model или zhihan1996/DNABERT-2-117M с Hugging Face.
"""
...
# Корень репозитория (родитель inference)
...
def tokenize_contigs(
    ...
    Args:
        ...
        model_path: путь к папке модели (по умолчанию inference/DNABERT2/model).
